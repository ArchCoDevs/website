...
<Tip type="danger">
  Setting `isVisible` to false will also prevent the tooltip from being shown
  when the element is hovered over or focused, so use this prop with caution
</Tip>
...
<Tip type="note">
  If you feel that one of the Jackanory components should be able to accept a
  ref, please contact a member of the development team or raise a pull request.
</Tip>

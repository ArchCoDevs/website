...
<Tip type="warning">
  One of the options is 'white'. This is useful for putting a loader on an item
  which is always dark. However if that item is light in dark-mode, then the
  loader will still be white. Use this option with caution.
</Tip>
...
<Tip type="note">
  The 'bar' and 'percentage-bar' loaders are not affected by this prop.
</Tip>
